...
<div className="flex flex-col items-center gap-5">
  <div className="flex items-center gap-2 mt-7">
    ...
    <div className="flex flex-col">
      ...
      <p className="text-slate-900 text-lg font-extrabold font-pretendard ml-3">오랜만에 갔다오니 너무 좋았어요!</p>
  ...
  <div className="flex items-center gap-2 mt-14">
    ...
    <div className="flex flex-col">
      ...
      <p className="text-slate-900 text-lg font-extrabold font-pretendard ml-3">서울 근처에 살고 있었는데 한 번도 가 본 적 없다가 최근에 가봤어요.</p>
